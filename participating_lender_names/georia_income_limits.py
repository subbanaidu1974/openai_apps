...
article_links = soup.find_all("a", href=re.compile("affordable-housing")) # find all a tags
relative_urls = [link["href"] for link in article_links if link["href"].startswith("/")]

urls = [f"https://dca.georgia.gov{relative_url}" for relative_url in relative_urls]
# print(urls)
...
# res = rag_chain_with_source.invoke("List all buyer mortgage programs")
# print(res['answer'])
