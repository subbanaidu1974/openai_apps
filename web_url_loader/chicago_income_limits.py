...
res = rag_chain_with_source.invoke("What is Chicago AMI ?")  
print(res['answer'])


res = rag_chain_with_source.invoke("Extract Area Median Income (AMI) Chart")
print(res['answer'])

res = rag_chain_with_source.invoke("Extract Area Median Income (AMI) Chart in tabular format")
print(res['answer'])

res = rag_chain_with_source.invoke("Extract Area Median Income (AMI) Chart as json format")
print(res['answer'])